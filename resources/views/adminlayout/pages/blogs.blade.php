          ...
          <table class="table table-striped projects">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $blog->author_name }}<br/><small>{{ $blog->author_email }}</small></td>
                    <td>{!! $blog->content !!}</td>
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="viewModalLabel{{ $blog->id }}">View Blog</h5>
                            ...
                            <div class="modal-body">
                              ...
                              <p><strong>Author:</strong> {{ $blog->author_name }} ({{ $blog->author_email }})</p>
                              <hr>
